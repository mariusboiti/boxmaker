...
export function applySimpleDefaults(settings: BoxSettings): BoxSettings {
  ...
  const width = clampNumber(rawInsideWidth, 20, 1000)
  const height = clampNumber(rawInsideHeight, 20, 1000)
  const depth = clampNumber(rawInsideDepth, 20, 1000)
