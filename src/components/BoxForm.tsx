...
import { getSimpleTemplateSettings, type SimpleBoxTemplateId } from '../lib/simplePresets'
...
export const BoxForm: FC<BoxFormProps> = ({
  ...
  const [simpleTemplateId, setSimpleTemplateId] = useState<SimpleBoxTemplateId>('small_gift')
      ...
      {mode === 'simple' ? (
        <section className="space-y-3">
          <p className="text-[11px] text-slate-400">
            1. Choose a template, 2. Adjust dimensions, 3. Download the SVG and cut it on your laser.
          </p>

          <div className="space-y-2">
            <div className="text-xs font-semibold uppercase tracking-wide text-slate-300">Box template</div>
            <div className="grid grid-cols-2 gap-2">
              {(
                [
                  { id: 'small_gift', label: 'Small gift box' },
                  { id: 'photo', label: 'Photo box' },
                  { id: 'ornament', label: 'Card/ornament box' },
                  { id: 'storage', label: 'Storage box' },
                ] as const
              ).map((tpl) => {
                const active = simpleTemplateId === tpl.id
                return (
                  <button
                    key={tpl.id}
                    type="button"
                    onClick={() => {
                      setSimpleTemplateId(tpl.id)
                      const patch = getSimpleTemplateSettings(tpl.id)
                      onChange({
                        ...value,
                        ...patch,
                        dimensionReference: 'inside',
                    ...
                    className={
                      active
                        ? 'rounded-md border border-sky-500 bg-sky-500/10 px-2 py-2 text-left text-[11px] text-slate-100'
                        : 'rounded-md border border-slate-800 bg-slate-950 px-2 py-2 text-left text-[11px] text-slate-200 hover:border-slate-700'
                    }
                  >
                    {tpl.label}
                  </button>
          ...
          <div className="space-y-2">
            <div className="text-xs font-semibold uppercase tracking-wide text-slate-300">Internal dimensions (mm)</div>
            <div className="grid grid-cols-3 gap-2">
              <label className="flex flex-col gap-1">
                ...
                <input
                  ...
                  max={1000}
                  step={0.1}
                  value={value.dimensionReference === 'inside' ? value.width : value.width}
            ...
            {simpleThicknessOption === 'custom' ? (
              <label className="flex flex-col gap-1 text-xs">
                ...
                <input
                  ...
                  max={30}
                  step={0.1}
                  value={value.materialThickness}
                  onChange={handleNumberChange('materialThickness')}
                  className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
                />
              </label>
            ) : (
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <label className="flex flex-col gap-1">
            ...
            <input
              ...
              step={0.01}
              value={value.kerf}
              onChange={handleNumberChange('kerf')}
              className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
            />
          </label>
            ...
            <div className="grid grid-cols-2 gap-2">
              <label className="flex flex-col gap-1">
                ...
                <input
                  ...
                  min={1}
                  step={0.1}
                  value={value.fingerMin}
                  onChange={handleNumberChange('fingerMin')}
                  className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
                />
              </label>
              <label className="flex flex-col gap-1">
                ...
                <input
                  ...
                  min={1}
                  step={0.1}
                  value={value.fingerMax}
                  onChange={handleNumberChange('fingerMax')}
                  className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
                />
              </label>
            </div>
          ...
          <div className="mt-1 grid grid-cols-2 gap-2 text-xs">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.1}
                value={value.grooveDepth}
                onChange={handleNumberChange('grooveDepth')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.1}
                value={value.grooveOffset}
                onChange={handleNumberChange('grooveOffset')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
          </div>
          ...
          <div className="mt-1 grid grid-cols-2 gap-2 text-xs">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.1}
                value={value.lipInset}
                onChange={handleNumberChange('lipInset')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.1}
                value={value.lipHeight}
                onChange={handleNumberChange('lipHeight')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            ...
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.05}
                value={value.dividerClearance}
                onChange={handleNumberChange('dividerClearance')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={10}
                step={1}
                value={value.sheetWidth}
                onChange={handleNumberChange('sheetWidth')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={10}
                step={1}
                value={value.sheetHeight}
                onChange={handleNumberChange('sheetHeight')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                min={0}
                step={0.5}
                value={value.partSpacing}
                onChange={handleNumberChange('partSpacing')}
                className="rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-xs focus:border-sky-500 focus:outline-none"
              />
            </label>
